...
MOCK_USDC_ADDRESS="${MOCK_USDC_ADDRESS:-0x2aD4A3782b1C323E6F6aEE51584e83818e8befda}"
SECRET_MARKETPLACE_ADDRESS="${SECRET_MARKETPLACE_ADDRESS:-0x65c44b9C025F9482Cc9B473efAd8301F6E780E08}"
