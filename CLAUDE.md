...
await client.privateTransfer({ recipient, token: SIMPLE_TOKEN_ADDRESS, amount: "1000000000000000000" });
await client.withdraw({ token: SIMPLE_TOKEN_ADDRESS, amount: "1000000000000000000" });
