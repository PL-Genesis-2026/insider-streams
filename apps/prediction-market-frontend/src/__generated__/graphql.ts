...
export type PredictionEventsQuery = { __typename?: 'Query', eventCreateds: Array<{ __typename?: 'EventCreated', id: string, eventId: string, creator: string, question: string, eventOpen: string, eventClose: string, duration: string, yesToken: string, noToken: string, blockTimestamp: string, transactionHash: string }>, settlementResponses: Array<{ __typename?: 'SettlementResponse', eventId: string, status: number, outcome: number, blockTimestamp: string, transactionHash: string }>, sharesPurchaseds: Array<{ __typename?: 'SharesPurchased', eventId: string, buyer: string, outcome: number, usdcIn: string, sharesOut: string, blockTimestamp: string, transactionHash: string }> };
