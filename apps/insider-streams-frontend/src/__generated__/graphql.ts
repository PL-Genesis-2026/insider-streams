...
export type HomepageAuctionListsQuery = { __typename?: 'Query', openAuctions: Array<{ __typename?: 'AuctionCreated', id: string, auctionId: string, sellerId: string, eventId: string, eventTitle: string, endTime: string, blockTimestamp: string, transactionHash: string }>, closedAuctions: Array<{ __typename?: 'AuctionClosed', id: string, auctionId: string, sellerId: string, winningBid: string, eventId: string, blockTimestamp: string, transactionHash: string }> };
...
export type HomepageClosedAuctionReferencesQuery = { __typename?: 'Query', referenceAuctions: Array<{ __typename?: 'AuctionCreated', id: string, auctionId: string, sellerId: string, eventId: string, eventTitle: string, endTime: string, blockTimestamp: string, transactionHash: string }> };
